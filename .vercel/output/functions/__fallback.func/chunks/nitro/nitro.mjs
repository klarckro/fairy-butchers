...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/site/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/events/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/music/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/members/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/sponsors/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/robinkalin/Documents/repos/fairy-butchers/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _hwTUkP = eventHandler(async (event) => {
...
const checksumsStructure = {
  "site": "2kHcKfgncBmb-QumVQkVuWLzViVCWur1biQ5zZAu_lk",
  "events": "X8ijq4qu0YMGqH2nfy6tB7L3ACPLPK7mI6BQlf1A-DY",
  "music": "ky-dgE40VmMhneJztovsLxx8NVHfl6u3f9sN5GaJARE",
  "members": "Z4yB1O6b5DNS2yQR3rRMgwLwTNn2u4B-eGWO5SCPd8g",
  "sponsors": "DnkbK1bbXumE89SsmI_PaA-zZm8hikTwJMQ-5LF4fpU"
};
...
const _ZjbSAM = eventHandler(async (event) => {
...
const handlers = [
  ...
  { route: '/__nuxt_content/music/sql_dump.txt', handler: _hwTUkP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/members/sql_dump.txt', handler: _hwTUkP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/sponsors/sql_dump.txt', handler: _hwTUkP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _hwTUkP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/site/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/events/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/music/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/members/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/sponsors/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _ZjbSAM, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_O_EGrm, lazy: true, middleware: false, method: undefined }
];
